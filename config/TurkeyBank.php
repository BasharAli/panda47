...
return [
    ...
    "UserName"            => env('KUVEYT_TURK_API_USERNAME', "VP080964"), // Test API Kullanıcısı : apiuser1
    "Password"            => env('KUVEYT_TURK_API_PASSWORD', '000877'),  // Test API Kullanıcı Şifresi : Api123
