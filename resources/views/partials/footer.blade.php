                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-3 ec-footer-contact">
                        <div class="ec-footer-widget">
                            <div class="ec-footer-logo"><a href="#"><img src="{{asset('main')}}/images/logo/footer-logo.png"
                                        alt=""><img class="dark-footer-logo" src="{{asset('main')}}/images/logo/dark-logo.png"
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-12 col-xs-12">
                        ...
                        <div class="qty-product-cover">
                            <div class="qty-slide">
                                <img class="img-responsive" src="{{asset('main')}}/images/product-image/3_1.jpg" alt="">
                            </div>
                            <div class="qty-slide">
                                <img class="img-responsive" src="{{asset('main')}}/images/product-image/3_2.jpg" alt="">
                            </div>
                            <div class="qty-slide">
                                <img class="img-responsive" src="{{asset('main')}}/images/product-image/3_3.jpg" alt="">
                            </div>
                            <div class="qty-slide">
                                <img class="img-responsive" src="{{asset('main')}}/images/product-image/3_4.jpg" alt="">
                            </div>
                            <div class="qty-slide">
                                <img class="img-responsive" src="{{asset('main')}}/images/product-image/3_5.jpg" alt="">
                            </div>
                        </div>
                    ...
                    <div class="col-md-7 col-sm-12 col-xs-12">
                        <div class="quickview-pro-content">
                            ...
                            <div class="ec-quickview-price">
                                <span class="old-price">TRY 100.00</span>
                                <span class="new-price">TRY 80.00</span>
                            </div>
                            ...
                            <div class="ec-quickview-qty">
                                ...
                                <div class="ec-quickview-cart ">
                                    <button class="btn btn-primary"><img src="{{asset('main')}}/images/icons/cart.svg"
...
<div id="ec-popnews-box">
    ...
    <div class="row">
        <div class="col-md-6 disp-no-767">
            <img src="{{asset('main')}}/images/banner/newsletter.png" alt="newsletter">
        </div>
        <div class="col-md-6">
        ...
        <div class="ec-nav-panel">
            ...
            <div class="ec-nav-panel-icons">
                <a href="#ec-side-cart" class="toggle-cart ec-header-btn ec-side-toggle"><img
                        src="{{asset('main')}}/images/icons/cart.svg" class="svg_img header_svg" alt="icon" /><span
                        class="ec-cart-noti ec-header-count cart-count-lable">3</span></a>
            </div>
            <div class="ec-nav-panel-icons">
                <a href="index.html" class="ec-header-btn"><img src="{{asset('main')}}/images/icons/home.svg"
                        class="svg_img header_svg" alt="icon" /></a>
            </div>
            <div class="ec-nav-panel-icons">
                <a href="wishlist.html" class="ec-header-btn"><img src="{{asset('main')}}/images/icons/wishlist.svg"
                        class="svg_img header_svg" alt="icon" /><span class="ec-cart-noti">4</span></a>
            </div>
            <div class="ec-nav-panel-icons">
                <a href="login.html" class="ec-header-btn"><img src="{{asset('main')}}/images/icons/user.svg"
                        class="svg_img header_svg" alt="icon" /></a>
            </div>
                    ...
                    <a class="ec-list" data-number="918866774266"
                        ...
                        <div class="d-flex bd-highlight">
                            ...
                            <div class="ec-img-cont">
                                <img src="{{asset('main')}}/images/whatsapp/profile_01.jpg" class="ec-user-img"
                                    alt="Profile image">
                ...
                <li>
                    <a class="ec-list" data-number="918866774266"
                        ...
                        <div class="d-flex bd-highlight">
                            <!-- Profile Picture -->
                            <div class="ec-img-cont">
                                <img src="{{asset('main')}}/images/whatsapp/profile_02.jpg" class="ec-user-img"
                                    alt="Profile image">
                ...
                <li>
                    <a class="ec-list" data-number="918866774266"
                        ...
                        <div class="d-flex bd-highlight">
                            <!-- Profile Picture -->
                            <div class="ec-img-cont">
                                <img src="{{asset('main')}}/images/whatsapp/profile_03.jpg" class="ec-user-img"
                                    alt="Profile image">
                ...
                <li>
                    <a class="ec-list" data-number="918866774266"
                        ...
                        <div class="d-flex bd-highlight">
                            <!-- Profile Picture -->
                            <div class="ec-img-cont">
                                <img src="{{asset('main')}}/images/whatsapp/profile_04.jpg" class="ec-user-img"
                                    alt="Profile image">
                                <span class="ec-status-icon ec-offline"></span>
                            </div>
                            <!-- Display Name & Last Seen -->
    ...
    <div class="ec-right-bottom">
        <div class="ec-box">
            <div class="ec-button rotateBackward">
                <img class="whatsapp" src="{{asset('main')}}/images/common/whatsapp.png" alt="whatsapp icon">
            </div>
        </div>
    </div>
...
<div class="ec-tools-sidebar">
    ...
    <a href="#" class="ec-tools-sidebar-toggle in-out">
        <img alt="icon" src="{{asset('main')}}/images/common/settings.png">
    </a>
