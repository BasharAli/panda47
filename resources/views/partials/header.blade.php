                    ...
                    <div class="col d-lg-none ">
                        <div class="ec-header-bottons">
                                    ...
                                    @if (Route::has('login'))
                                        @auth
                                            @if (Auth::user()->utype === "ADM")
                                                <li><a class="dropdown-item" href="{{route('adminpanel')}}">Go To Admin Panel</a></li>
                            ...
                            <a href="{{url('wishlist')}}" class="ec-header-btn ec-header-wishlist">
                                ...
                                <span class="ec-header-count">6</span>
                            </a>
                            <!-- Header wishlist End -->
                            <!-- Header Cart Start -->
                        ...
                        <div class="col">
                            <div class="header-search">
                                <form class="ec-btn-group-form" action="{{route('product.search')}}" method="GET">
                                    <input name="search" class="form-control ec-search-bar" placeholder="Search products..." type="text">
