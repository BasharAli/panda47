					...
					<div class="breadcrumb-wrapper breadcrumb-contacts">
						<div>
							...
							<p class="breadcrumbs"><span><a href="{{url('admin/dashboard')}}">Home</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span><span><a href="{{url('admin/vendor-list')}}">Vendor List</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span>{{$shop->shopname}}
							</p>
						</div>
						<div>
						</div>
								...
								<div class="profile-content-left profile-left-spacing">
									<div class="ec-disp">
										<div class="text-center widget-profile px-0 border-0">
											<div class="">
												<img src="{{asset('main')}}/images/logos/{{$shop->shop_logo}}" style="height: fit-content !important" alt="shop image">
											</div>
											<div class="card-body">
												<h4 class="py-2 text-dark">{{$shop->user->firstname}} {{$shop->user->lastname}}</h4>
												<p>{{$shop->user->email}}</p>
											</div>
										</div>
									...
									<div class="contact-info pt-4">
										...
										<p>{{$shop->user->date}}</p>
										<p class="text-dark font-weight-medium pt-24px mb-2">Contract</p>
										@if ($shop->contract)
											<a target="_blank" href="{{asset('main')}}/images/contracts/{{$shop->contract}}"> See Contract Archive</a>
										@else
											<form action="" wire:submit.prevent="uploadContract" enctype="multipart/form-data">
												<div class="form-group">
												<input type="file" class="form-control-file" accept=".pdf" id="conract" placeholder="Upload Contract File" wire:model="contract">
												<div wire:loading wire:target="uploadContract" class="loader">Uploading...</div>
												</div>
												...
												<div class="row">
													<div class="col-xl-12">
														<div class="media widget-media p-3 bg-white border">
															...
															<div class="media-body align-self-center">
																<h4 class="text-primary mb-2">{{$shop->shopname}}</h4>
																<p>Shop Name</p>
															</div>
														</div>
													</div>
													<div class="col-xl-12">
														<div class="media widget-media p-3 bg-white border">
															...
															<div class="media-body align-self-center">
																<img class="mb-3" src="{{asset('main')}}/images/covers/{{$shop->shop_cover}}" width="100%" height="" alt="">
													...
													<div class="col-xl-4">
														<div class="media widget-media p-3 bg-white border">
															...
															<div class="media-body align-self-center">
																<h4 class="text-primary mb-2">{{$shop->products->count()}}</h4>
																<p>Products</p>
															</div>
														</div>
													</div>
													...
													<div class="col-xl-4">
														<div class="media widget-media p-3 bg-white border">
															...
															<div class="media-body align-self-center">
																<h4 class="text-primary mb-2">{{$shop->type}}</h4>
																<p>Company Type</p>
															</div>
														</div>
													</div>
													...
													<div class="col-xl-4">
														<div class="media widget-media p-3 bg-white border">
															...
															<div class="media-body align-self-center">
																<h4 class="text-primary mb-2">{{$shop->tckn}}</h4>
																<p>TCKN</p>
															</div>
														</div>
													</div>
													<div class="col-xl-4">
														<div class="media widget-media p-3 bg-white border">
															...
															<div class="media-body align-self-center">
																<h4 class="text-primary mb-2">{{$shop->city}}/{{$shop->district}}</h4>
																<p>Address</p>
															</div>
														</div>
													</div>
													<div class="col-xl-4">
														<div class="media widget-media p-3 bg-white border">
															...
															<div class="media-body align-self-center">
																<h4 class="text-primary mb-2">{{$shop->taxid}}</h4>
																<p>TAX ID</p>
															</div>
														</div>
													</div>
													<div class="col-xl-4">
														<div class="media widget-media p-3 bg-white border">
															...
															<div class="media-body align-self-center">
																<h4 class="text-primary mb-2">{{$shop->slug}}</h4>
																<p>SLUG</p>
															</div>
														</div>
													</div>
													<div class="col-xl-4">
														<div class="media widget-media p-3 bg-white border">
															...
															<div class="media-body align-self-center">
																<h4 class="text-primary mb-2">{{$shop->created_at->format('Y-m-d')}}</h4>
																<p>Date Joined</p>
															</div>
														</div>
													</div>
													...
													<div class="col-xl-12">
														...
														<div class="card card-default mb-24px">
															...
															<div class="card-body compact-notifications" style="height: 150px;">
