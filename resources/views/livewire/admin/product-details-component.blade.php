														...
														<div class="single-product-cover">
															<div class="single-slide zoom-image-hover">
																<img class="img-responsive"
																	src="{{asset('admin')}}/img/products/pd_1.jpg" alt="">
															</div>
															<div class="single-slide zoom-image-hover">
																<img class="img-responsive"
																	src="{{asset('admin')}}/img/products/pd_2.jpg" alt="">
															</div>
															<div class="single-slide zoom-image-hover">
																<img class="img-responsive"
																	src="{{asset('admin')}}/img/products/pd_3.jpg" alt="">
															</div>
															<div class="single-slide zoom-image-hover">
																<img class="img-responsive"
																	src="{{asset('admin')}}/img/products/pd_4.jpg" alt="">
															</div>
															<div class="single-slide zoom-image-hover">
																<img class="img-responsive"
																	src="{{asset('admin')}}/img/products/pd_5.jpg" alt="">
															</div>
														</div>
												...
												<div class="card-body text-center">
													<a href="javascript:0" class="text-secondary d-inline-block">
														<div class="image mb-3">
															<img src="{{asset('admin')}}/img/user/u-xl-4.jpg"
													...
													<div class="ec-t-review-wrapper">
														<div class="ec-t-review-item">
															<div class="ec-t-review-avtar">
																<img src="{{asset('admin')}}/img/review-image/1.jpg" alt="">
															</div>
														...
														<div class="ec-t-review-item">
															<div class="ec-t-review-avtar">
																<img src="{{asset('admin')}}/img/review-image/2.jpg" alt="">
															</div>
															<div class="ec-t-review-content">
																<div class="ec-t-review-top">
