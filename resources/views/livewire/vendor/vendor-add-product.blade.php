                            ...
                            <div class="row">
                                        ...
                                        <div class="ec-vendor-main-img">
                                            <div class="avatar-upload">
                                                <div class="avatar-edit">
                                                    ...
                                                    accept=".png, .jpg, .jpeg, .webp" wire:model="product_img" />
                                                ...
                                                @error('product_img') <span class="error text-danger text-center">{{ $message }}</span> @enderror
                                            </div>
                                                    ...
                                                    <div class="thumb-upload">
                                                        <div class="thumb-edit">
                                                            <input type='file' id="thumbUpload01" class="ec-image-upload"
                                                                accept=".png, .jpg, .jpeg, .webp" multiple wire:model="images"/>
                                                            <label for="imageUpload"><img src="{{asset('main')}}/images/icons/edit.svg"
                                                                    class="svg_img header_svg" alt="edit" /></label>
                                                        </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="ec-vendor-upload-detail">
                                        <form class="row g-3" enctype="multipart/form-data" wire:submit.prevent="storeProduct">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="slug" wire:model="product_slug">
                                            </div>
                                            <div class="col-md-6">
