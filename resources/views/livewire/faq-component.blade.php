                ...
                <div class="col-12">
                    <div class="row ec_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ec-breadcrumb-title">{{__('FAQ')}}</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- ec-breadcrumb-list start -->
                            <ul class="ec-breadcrumb-list">
                                <li class="ec-breadcrumb-item"><a href="{{url('/')}}">{{__('Home')}}</a></li>
                                <li class="ec-breadcrumb-item active">{{__('FAQ')}}</li>
                            </ul>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        <h2 class="ec-bg-title">{{__('FAQ')}}</h2>
                        <h2 class="ec-title">{{__('FAQ')}}</h2>
                        <p class="sub-title mb-3">{{__('We are glad to help you, please contact us if nothing helpful found')}}</p>
                    </div>
                </div>
