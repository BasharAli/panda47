                ...
                <div class="col-12">
                    <div class="row ec_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ec-breadcrumb-title">{{__('Hot Offer')}}</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- ec-breadcrumb-list start -->
                            <ul class="ec-breadcrumb-list">
                                <li class="ec-breadcrumb-item"><a href="{{url('/')}}">{{__('Home')}}</a></li>
                                <li class="ec-breadcrumb-item active">{{__('Hot Offer')}}</li>
                            </ul>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12 margin-b-30">
                    <div class="ec-offer-coupon">
                        <div class="ec-cpn-brand">
                            <img class="ec-brand-img" src="{{asset('main')}}/images/offer-image/2.jpg" alt="" />
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12 margin-b-30">
                    <div class="ec-offer-coupon">
                        <div class="ec-cpn-brand">
                            <img class="ec-brand-img" src="{{asset('main')}}/images/offer-image/3.jpg" alt="" />
                        </div>
                        <div class="ec-cpn-title">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12 m-auto">
                    <div class="ec-offer-coupon">
                        <div class="ec-cpn-brand">
                            <img class="ec-brand-img" src="{{asset('main')}}/images/offer-image/4.jpg" alt="" />
                        </div>
                        <div class="ec-cpn-title">
